...
export default function FloatingWhatsApp() {
  const href = `https://wa.me/${siteContent.whatsappNumber}?text=${encodeURIComponent(
  ...
  return (
    <div className="group fixed z-[130] flex flex-col items-end gap-2 right-4 bottom-24 sm:right-5 sm:bottom-[5.5rem]">
      ...
      <a
        ...
        className="flex h-[52px] w-[52px] items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-green-600/30 transition-transform hover:scale-110"
      >
        <WhatsAppIcon />
      </a>
    </div>
